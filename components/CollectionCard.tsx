  ...
  return (
    <div className="w-full sm:w-[330px] cursor-pointer">
      <div className="w-full sm:w-[330px] sm:h-[330px] rounded-[20px] duration-300 overflow-hidden collection-img-wrapper">
        <CustomImage
          classList="!mx-auto !duration-300"
      ...
      <div className="flex justify-between mt-[15px]">
        ...
        <button className="w-[30%] sm:h-[100px] rounded-[20px] bg-[#A259FF] text-white flex items-center justify-center font-bold text-[22px]">
          {item.images.length}
        </button>
      </div>
